...
QT_MOC_LITERAL(3, 31, 11), // "recvMessage"
QT_MOC_LITERAL(4, 43, 12) // "removeClient"

    },
    "ServerHandler\0messageReceived\0\0"
    "recvMessage\0removeClient"
};
...
void ServerHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->recvMessage((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 2: _t->removeClient((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ServerHandler::messageReceived)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ServerHandler::messageReceived(QString _t1)
{
